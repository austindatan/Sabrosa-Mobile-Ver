...
const Bluestar = () => {
  ...
  React.useEffect(() => {
    fetch(`${config.API_BASE_URL}/api/products/brand/Bluestar`)
      .then(res => res.json())
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      <AnimatedHeader
        brandName="Bluestar"
        brandTagline="Donuts for Grownups.                                             "
        backgroundImage={require("../../../assets/images/initialization_assets/bluestar_bg.png")}
        brandLogo={require("../../../assets/images/initialization_assets/logo/bluestar.png")}
      />
