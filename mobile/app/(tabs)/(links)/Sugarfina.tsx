...
const Sugarfina = () => {
  ...
  React.useEffect(() => {
    fetch(`${config.API_BASE_URL}/api/products/brand/Sugarfina`)
      .then(res => res.json())
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      <AnimatedHeader
        brandName="Sugarfina"
        brandTagline="Luxury candies for the modern connoisseur."
        backgroundImage={require("../../../assets/images/initialization_assets/sugarfina_bg.png")}
        brandLogo={require("../../../assets/images/initialization_assets/logo/sugarfina.png")}
      />
