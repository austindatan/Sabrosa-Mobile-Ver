...
const Compartes = () => {
  ...
  React.useEffect(() => {
    fetch(`${config.API_BASE_URL}/api/products/brand/Compartes`)
      .then(res => res.json())
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      <AnimatedHeader
        ...
        backgroundImage={require("../../../assets/images/initialization_assets/compartes_alternative.png")}
