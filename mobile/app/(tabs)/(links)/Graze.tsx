...
const Graze = () => {
  ...
  React.useEffect(() => {
    fetch(`${config.API_BASE_URL}/api/products/brand/Graze`)
      .then(res => res.json())
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      <AnimatedHeader
        brandName="Graze"
        brandTagline="Wholesome snacks, perfectly portioned."
        backgroundImage={require("../../../assets/images/initialization_assets/graze_bg.png")}
        brandLogo={require("../../../assets/images/initialization_assets/logo/graze.png")}
      />
