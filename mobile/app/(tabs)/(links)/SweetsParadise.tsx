...
const SweetsParadise = () => {
  ...
  React.useEffect(() => {
    fetch(`${config.API_BASE_URL}/api/products/brand/SweetsParadise`)
      .then(res => res.json())
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      <AnimatedHeader
        ...
        brandName="Sweets Paradise"
        brandTagline="Sweets Paradise: A Taste of Happiness in Every Bite                                             "
        backgroundImage={require("../../../assets/images/initialization_assets/sweetsparadise_bg.png")}
