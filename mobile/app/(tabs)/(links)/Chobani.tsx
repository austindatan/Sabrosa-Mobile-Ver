  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      <AnimatedHeader
        ...
        brandName="Chobani"
        brandTagline="Nutrition puzzle, solved. To love this life is to live it naturally. "
        backgroundImage={require("../../../assets/images/initialization_assets/chobani_bg.png")}
        brandLogo={require("../../../assets/images/initialization_assets/logo/chobani.png")}
      />
